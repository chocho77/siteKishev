...
@Component({
  selector: 'app-storknestswing90cowithnet',
  standalone: true,
  imports: [],
  templateUrl: './storknestswing90cowithnet.component.html',
  styleUrl: './storknestswing90cowithnet.component.css'
})
export class Storknestswing90cowithnetComponent {
